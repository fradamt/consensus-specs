...
Count duty-fresh parent votes when they support the payload branch required by
the child or have PENDING status. A PENDING parent vote supports neither resolved
payload branch. A vote for the other resolved status supports the competing branch.
